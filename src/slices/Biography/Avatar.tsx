  ...
  return (
    <div ref={component} className={clsx("relative h-full w-full", className)}>
      <div
        ...
        style={{ perspective: "500px", perspectiveOrigin: "50% 50%", height: "350px", width: "350px" }}
      >
        <PrismicNextImage
          field={image}
          className={clsx("avatar-image h-full w-full object-cover", "7xl:avatar-image-fullscreen")}
          imgixParams={{ q: 90 }}
        />
