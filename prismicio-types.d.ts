...
export interface ExperienceSliceDefaultPrimaryRoleItem {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.role[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Item in *TechList → Default → Primary → Tech Name and Color*
 */
export interface TechListSliceDefaultPrimaryTechNameAndColorItem {
  /**
   * Tech Name field in *TechList → Default → Primary → Tech Name and Color*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_name_and_color[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Tech Color field in *TechList → Default → Primary → Tech Name and Color*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_name_and_color[].tech_color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech Name and Color field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_name_and_color[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  tech_name_and_color: prismic.GroupField<
    Simplify<TechListSliceDefaultPrimaryTechNameAndColorItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      TechListSlice,
      TechListSliceDefaultPrimaryTechNameAndColorItem,
